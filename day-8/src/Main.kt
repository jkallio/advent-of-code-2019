 ...
 *      Layer 1: 02          Layer 2: 11        Layer 3: 22         Layer 4: 00
 *               22                   22                 12                  00
 *
 ...
 *      -> Your puzzle answer was KFABY (see attached output.jpg)
 */
...
fun main(args: Array<String>) {
    ...
    val img = Image(input, 25, 6)

    // Part-1
    img.findLayerWithFewest(0)?.let {
        val a = img.numberOfValuesInLayer(it, 1)
        val b = img.numberOfValuesInLayer(it,2)
        println("Result = ${a * b}")
    }
